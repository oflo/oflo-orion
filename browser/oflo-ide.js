...
require.register("oflo-oflo-ide/index.js", function(exports, require, module){

});
require.register("oflo-oflo-ide/component.json", function(exports, require, module){
module.exports = JSON.parse('{"name":"oflo-ide","remotes":["http://localhost:3000"],"dependencies":{"meemoo/dataflow":"*","component/emitter":"*","noflo/noflo":"*","noflo/noflo-strings":"*","noflo/noflo-ajax":"*","noflo/noflo-localstorage":"*","noflo/noflo-interaction":"*","noflo/noflo-objects":"*","noflo/noflo-groups":"*","noflo/noflo-dom":"*","noflo/noflo-core":"*"},"main":"index.js","scripts":["index.js","src/plugins/nofloLibrary.coffee","src/plugins/nofloGraph.coffee","src/plugins/nofloSettings.coffee","src/plugins/ofloSave.coffee","src/plugins/preview.coffee","src/runtimes/base.coffee","src/runtimes/window.coffee"],"json":["component.json"],"files":["css/oflo-ide.css","index.html","favicon.ico","noflo.png"],"repo":"http://localhost:3000/oflo/oflo-ide"}');
});
require.register("oflo-oflo-ide/src/plugins/nofloLibrary.js", function(exports, require, module){
...
require.register("oflo-oflo-ide/src/plugins/nofloGraph.js", function(exports, require, module){
...
require.register("oflo-oflo-ide/src/plugins/nofloSettings.js", function(exports, require, module){
...
require.register("oflo-oflo-ide/src/plugins/ofloSave.js", function(exports, require, module){
var Dataflow, HanaFloSave, plugin;

Dataflow = require('/meemoo-dataflow').Dataflow;

HanaFloSave = (function() {
  function HanaFloSave() {}

  HanaFloSave.prototype.initialize = function(dataflow) {
    var _this = this;
    this.runtime = null;
    this.$connector = $("<div class=\"noflo-ui-save\">      <h2><i></i> <span>Save Graph</span></h2>      <div class=\"toolbar\">        <button class=\"save btn\"><i class=\"icon-save\"></i></button>      </div>    </div>");
    this.$saveButton = this.$connector.find('.save');
    dataflow.addPlugin({
      id: 'save',
      name: '',
      label: 'save',
...
plugin = Dataflow.prototype.plugin('graphsave');

Dataflow.prototype.plugins['graphsave'] = new HanaFloSave;

});
require.register("oflo-oflo-ide/src/plugins/preview.js", function(exports, require, module){
...
require.register("oflo-oflo-ide/src/runtimes/base.js", function(exports, require, module){
...
require.register("oflo-oflo-ide/src/runtimes/window.js", function(exports, require, module){
var Base, WindowRuntime,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
WindowRuntime = (function(_super) {
  __extends(WindowRuntime, _super);

  function WindowRuntime(graph) {
    this.onMessage = __bind(this.onMessage, this);
    this.onLoaded = __bind(this.onLoaded, this);
    this.origin = window.location.origin;
    WindowRuntime.__super__.constructor.call(this, graph);
  }

  WindowRuntime.prototype.getType = function() {
    return 'window';
  };

  WindowRuntime.prototype.setParentElement = function(parent) {
    this.remote = window.open('/saphana/hanaflo-runtime-ui/index.html?hf-remote=true');
    return this.remote;
  };

  WindowRuntime.prototype.connect = function(target) {
    this.remote = window.open(target.ui);
    this.remote.addEventListener('load', this.onLoaded, false);
    this.emit('status', {
      state: 'pending',
      label: 'connecting'
    });
  ...
  WindowRuntime.prototype.disconnect = function(protocol) {
    this.remote.removeEventListener('load', this.onLoaded, false);
  ...
  WindowRuntime.prototype.onLoaded = function() {
    this.emit('status', {
      state: 'online',
      label: 'connected'
    });
  ...
  WindowRuntime.prototype.getElement = function() {
    return this.remote;
  };

  WindowRuntime.prototype.send = function(protocol, command, payload) {
    var w;
    w = this.remote;
    if (!w) {
      return;
  ...
  WindowRuntime.prototype.onMessage = function(message) {
...
require.register("oflo-orion/index.js", function(exports, require, module){

});
require.register("oflo-orion/component.json", function(exports, require, module){
module.exports = JSON.parse('{"name":"oflo-orion","remotes":["http://localhost:3000"],"dependencies":{"oflo/oflo-ide":"*","meemoo/dataflow":"*","component/emitter":"*","noflo/noflo":"*","noflo/noflo-strings":"*","noflo/noflo-ajax":"*","noflo/noflo-localstorage":"*","noflo/noflo-interaction":"*","noflo/noflo-objects":"*","noflo/noflo-groups":"*","noflo/noflo-dom":"*","noflo/noflo-core":"*"},"main":"index.js","scripts":["index.js"],"files":["oflo/oflo.css","oflo/oflo.html","oflo/oflo.js","oflo/test.json"],"json":["component.json"]}');
});
...
require.alias("oflo-oflo-ide/index.js", "oflo-orion/deps/oflo-ide/index.js");
require.alias("oflo-oflo-ide/component.json", "oflo-orion/deps/oflo-ide/component.json");
require.alias("oflo-oflo-ide/src/plugins/nofloLibrary.js", "oflo-orion/deps/oflo-ide/src/plugins/nofloLibrary.js");
require.alias("oflo-oflo-ide/src/plugins/nofloGraph.js", "oflo-orion/deps/oflo-ide/src/plugins/nofloGraph.js");
require.alias("oflo-oflo-ide/src/plugins/nofloSettings.js", "oflo-orion/deps/oflo-ide/src/plugins/nofloSettings.js");
require.alias("oflo-oflo-ide/src/plugins/ofloSave.js", "oflo-orion/deps/oflo-ide/src/plugins/ofloSave.js");
require.alias("oflo-oflo-ide/src/plugins/preview.js", "oflo-orion/deps/oflo-ide/src/plugins/preview.js");
require.alias("oflo-oflo-ide/src/runtimes/base.js", "oflo-orion/deps/oflo-ide/src/runtimes/base.js");
require.alias("oflo-oflo-ide/src/runtimes/window.js", "oflo-orion/deps/oflo-ide/src/runtimes/window.js");
require.alias("oflo-oflo-ide/index.js", "oflo-orion/deps/oflo-ide/index.js");
require.alias("oflo-oflo-ide/index.js", "oflo-ide/index.js");
require.alias("meemoo-dataflow/build/dataflow.build.js", "oflo-oflo-ide/deps/dataflow/build/dataflow.build.js");
require.alias("meemoo-dataflow/build/dataflow.build.js", "oflo-oflo-ide/deps/dataflow/index.js");
require.alias("meemoo-dataflow/build/dataflow.build.js", "meemoo-dataflow/index.js");
require.alias("component-emitter/index.js", "oflo-oflo-ide/deps/emitter/index.js");
require.alias("component-indexof/index.js", "component-emitter/deps/indexof/index.js");

require.alias("noflo-noflo/component.json", "oflo-oflo-ide/deps/noflo/component.json");
require.alias("noflo-noflo/src/lib/Graph.js", "oflo-oflo-ide/deps/noflo/src/lib/Graph.js");
require.alias("noflo-noflo/src/lib/InternalSocket.js", "oflo-oflo-ide/deps/noflo/src/lib/InternalSocket.js");
require.alias("noflo-noflo/src/lib/Port.js", "oflo-oflo-ide/deps/noflo/src/lib/Port.js");
require.alias("noflo-noflo/src/lib/ArrayPort.js", "oflo-oflo-ide/deps/noflo/src/lib/ArrayPort.js");
require.alias("noflo-noflo/src/lib/Component.js", "oflo-oflo-ide/deps/noflo/src/lib/Component.js");
require.alias("noflo-noflo/src/lib/AsyncComponent.js", "oflo-oflo-ide/deps/noflo/src/lib/AsyncComponent.js");
require.alias("noflo-noflo/src/lib/LoggingComponent.js", "oflo-oflo-ide/deps/noflo/src/lib/LoggingComponent.js");
require.alias("noflo-noflo/src/lib/ComponentLoader.js", "oflo-oflo-ide/deps/noflo/src/lib/ComponentLoader.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "oflo-oflo-ide/deps/noflo/src/lib/NoFlo.js");
require.alias("noflo-noflo/src/lib/Network.js", "oflo-oflo-ide/deps/noflo/src/lib/Network.js");
require.alias("noflo-noflo/src/components/Graph.js", "oflo-oflo-ide/deps/noflo/src/components/Graph.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "oflo-oflo-ide/deps/noflo/index.js");
...
require.alias("noflo-noflo-strings/index.js", "oflo-oflo-ide/deps/noflo-strings/index.js");
require.alias("noflo-noflo-strings/component.json", "oflo-oflo-ide/deps/noflo-strings/component.json");
require.alias("noflo-noflo-strings/components/CompileString.js", "oflo-oflo-ide/deps/noflo-strings/components/CompileString.js");
require.alias("noflo-noflo-strings/components/Filter.js", "oflo-oflo-ide/deps/noflo-strings/components/Filter.js");
require.alias("noflo-noflo-strings/components/SendString.js", "oflo-oflo-ide/deps/noflo-strings/components/SendString.js");
require.alias("noflo-noflo-strings/components/SplitStr.js", "oflo-oflo-ide/deps/noflo-strings/components/SplitStr.js");
require.alias("noflo-noflo-strings/components/StringTemplate.js", "oflo-oflo-ide/deps/noflo-strings/components/StringTemplate.js");
require.alias("noflo-noflo-strings/components/Replace.js", "oflo-oflo-ide/deps/noflo-strings/components/Replace.js");
require.alias("noflo-noflo-strings/components/Jsonify.js", "oflo-oflo-ide/deps/noflo-strings/components/Jsonify.js");
require.alias("noflo-noflo-strings/components/ParseJson.js", "oflo-oflo-ide/deps/noflo-strings/components/ParseJson.js");
...
require.alias("noflo-noflo-ajax/index.js", "oflo-oflo-ide/deps/noflo-ajax/index.js");
require.alias("noflo-noflo-ajax/component.json", "oflo-oflo-ide/deps/noflo-ajax/component.json");
require.alias("noflo-noflo-ajax/components/Get.js", "oflo-oflo-ide/deps/noflo-ajax/components/Get.js");
require.alias("noflo-noflo-ajax/components/GetJsonP.js", "oflo-oflo-ide/deps/noflo-ajax/components/GetJsonP.js");
...
require.alias("noflo-fbp/lib/fbp.js", "noflo-fbp/index.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "noflo-noflo/index.js");
require.alias("noflo-noflo-localstorage/index.js", "oflo-oflo-ide/deps/noflo-localstorage/index.js");
require.alias("noflo-noflo-localstorage/component.json", "oflo-oflo-ide/deps/noflo-localstorage/component.json");
require.alias("noflo-noflo-localstorage/components/GetItem.js", "oflo-oflo-ide/deps/noflo-localstorage/components/GetItem.js");
require.alias("noflo-noflo-localstorage/components/ListenRemoteChanges.js", "oflo-oflo-ide/deps/noflo-localstorage/components/ListenRemoteChanges.js");
require.alias("noflo-noflo-localstorage/components/ListAdd.js", "oflo-oflo-ide/deps/noflo-localstorage/components/ListAdd.js");
require.alias("noflo-noflo-localstorage/components/ListGet.js", "oflo-oflo-ide/deps/noflo-localstorage/components/ListGet.js");
require.alias("noflo-noflo-localstorage/components/ListRemove.js", "oflo-oflo-ide/deps/noflo-localstorage/components/ListRemove.js");
require.alias("noflo-noflo-localstorage/components/RemoveItem.js", "oflo-oflo-ide/deps/noflo-localstorage/components/RemoveItem.js");
require.alias("noflo-noflo-localstorage/components/SetItem.js", "oflo-oflo-ide/deps/noflo-localstorage/components/SetItem.js");
...
require.alias("noflo-fbp/lib/fbp.js", "noflo-fbp/index.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "noflo-noflo/index.js");
require.alias("noflo-noflo-interaction/index.js", "oflo-oflo-ide/deps/noflo-interaction/index.js");
require.alias("noflo-noflo-interaction/component.json", "oflo-oflo-ide/deps/noflo-interaction/component.json");
require.alias("noflo-noflo-interaction/components/ListenDrag.js", "oflo-oflo-ide/deps/noflo-interaction/components/ListenDrag.js");
require.alias("noflo-noflo-interaction/components/ListenHash.js", "oflo-oflo-ide/deps/noflo-interaction/components/ListenHash.js");
require.alias("noflo-noflo-interaction/components/ListenKeyboard.js", "oflo-oflo-ide/deps/noflo-interaction/components/ListenKeyboard.js");
require.alias("noflo-noflo-interaction/components/ListenMouse.js", "oflo-oflo-ide/deps/noflo-interaction/components/ListenMouse.js");
require.alias("noflo-noflo-interaction/components/ListenPointer.js", "oflo-oflo-ide/deps/noflo-interaction/components/ListenPointer.js");
require.alias("noflo-noflo-interaction/components/ListenScroll.js", "oflo-oflo-ide/deps/noflo-interaction/components/ListenScroll.js");
require.alias("noflo-noflo-interaction/components/ListenSpeech.js", "oflo-oflo-ide/deps/noflo-interaction/components/ListenSpeech.js");
require.alias("noflo-noflo-interaction/components/ListenTouch.js", "oflo-oflo-ide/deps/noflo-interaction/components/ListenTouch.js");
require.alias("noflo-noflo-interaction/components/SetHash.js", "oflo-oflo-ide/deps/noflo-interaction/components/SetHash.js");
require.alias("noflo-noflo-interaction/components/ReadCoordinates.js", "oflo-oflo-ide/deps/noflo-interaction/components/ReadCoordinates.js");
...
require.alias("noflo-fbp/lib/fbp.js", "noflo-fbp/index.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "noflo-noflo/index.js");
require.alias("noflo-noflo-objects/index.js", "oflo-oflo-ide/deps/noflo-objects/index.js");
require.alias("noflo-noflo-objects/component.json", "oflo-oflo-ide/deps/noflo-objects/component.json");
require.alias("noflo-noflo-objects/components/Extend.js", "oflo-oflo-ide/deps/noflo-objects/components/Extend.js");
require.alias("noflo-noflo-objects/components/MergeObjects.js", "oflo-oflo-ide/deps/noflo-objects/components/MergeObjects.js");
require.alias("noflo-noflo-objects/components/SplitObject.js", "oflo-oflo-ide/deps/noflo-objects/components/SplitObject.js");
require.alias("noflo-noflo-objects/components/ReplaceKey.js", "oflo-oflo-ide/deps/noflo-objects/components/ReplaceKey.js");
require.alias("noflo-noflo-objects/components/Keys.js", "oflo-oflo-ide/deps/noflo-objects/components/Keys.js");
require.alias("noflo-noflo-objects/components/Size.js", "oflo-oflo-ide/deps/noflo-objects/components/Size.js");
require.alias("noflo-noflo-objects/components/Values.js", "oflo-oflo-ide/deps/noflo-objects/components/Values.js");
require.alias("noflo-noflo-objects/components/Join.js", "oflo-oflo-ide/deps/noflo-objects/components/Join.js");
require.alias("noflo-noflo-objects/components/ExtractProperty.js", "oflo-oflo-ide/deps/noflo-objects/components/ExtractProperty.js");
require.alias("noflo-noflo-objects/components/InsertProperty.js", "oflo-oflo-ide/deps/noflo-objects/components/InsertProperty.js");
require.alias("noflo-noflo-objects/components/SliceArray.js", "oflo-oflo-ide/deps/noflo-objects/components/SliceArray.js");
require.alias("noflo-noflo-objects/components/SplitArray.js", "oflo-oflo-ide/deps/noflo-objects/components/SplitArray.js");
require.alias("noflo-noflo-objects/components/FilterPropertyValue.js", "oflo-oflo-ide/deps/noflo-objects/components/FilterPropertyValue.js");
require.alias("noflo-noflo-objects/components/FlattenObject.js", "oflo-oflo-ide/deps/noflo-objects/components/FlattenObject.js");
require.alias("noflo-noflo-objects/components/MapProperty.js", "oflo-oflo-ide/deps/noflo-objects/components/MapProperty.js");
require.alias("noflo-noflo-objects/components/RemoveProperty.js", "oflo-oflo-ide/deps/noflo-objects/components/RemoveProperty.js");
require.alias("noflo-noflo-objects/components/MapPropertyValue.js", "oflo-oflo-ide/deps/noflo-objects/components/MapPropertyValue.js");
require.alias("noflo-noflo-objects/components/GetObjectKey.js", "oflo-oflo-ide/deps/noflo-objects/components/GetObjectKey.js");
require.alias("noflo-noflo-objects/components/UniqueArray.js", "oflo-oflo-ide/deps/noflo-objects/components/UniqueArray.js");
require.alias("noflo-noflo-objects/components/SetProperty.js", "oflo-oflo-ide/deps/noflo-objects/components/SetProperty.js");
require.alias("noflo-noflo-objects/components/SimplifyObject.js", "oflo-oflo-ide/deps/noflo-objects/components/SimplifyObject.js");
require.alias("noflo-noflo-objects/components/DuplicateProperty.js", "oflo-oflo-ide/deps/noflo-objects/components/DuplicateProperty.js");
require.alias("noflo-noflo-objects/components/CreateObject.js", "oflo-oflo-ide/deps/noflo-objects/components/CreateObject.js");
require.alias("noflo-noflo-objects/components/CreateDate.js", "oflo-oflo-ide/deps/noflo-objects/components/CreateDate.js");
require.alias("noflo-noflo-objects/components/SetPropertyValue.js", "oflo-oflo-ide/deps/noflo-objects/components/SetPropertyValue.js");
require.alias("noflo-noflo-objects/components/CallMethod.js", "oflo-oflo-ide/deps/noflo-objects/components/CallMethod.js");
...
require.alias("noflo-noflo-groups/index.js", "oflo-oflo-ide/deps/noflo-groups/index.js");
require.alias("noflo-noflo-groups/component.json", "oflo-oflo-ide/deps/noflo-groups/component.json");
require.alias("noflo-noflo-groups/components/ReadGroups.js", "oflo-oflo-ide/deps/noflo-groups/components/ReadGroups.js");
require.alias("noflo-noflo-groups/components/RemoveGroups.js", "oflo-oflo-ide/deps/noflo-groups/components/RemoveGroups.js");
require.alias("noflo-noflo-groups/components/Regroup.js", "oflo-oflo-ide/deps/noflo-groups/components/Regroup.js");
require.alias("noflo-noflo-groups/components/Group.js", "oflo-oflo-ide/deps/noflo-groups/components/Group.js");
require.alias("noflo-noflo-groups/components/GroupZip.js", "oflo-oflo-ide/deps/noflo-groups/components/GroupZip.js");
require.alias("noflo-noflo-groups/components/FilterByGroup.js", "oflo-oflo-ide/deps/noflo-groups/components/FilterByGroup.js");
require.alias("noflo-noflo-groups/components/Objectify.js", "oflo-oflo-ide/deps/noflo-groups/components/Objectify.js");
require.alias("noflo-noflo-groups/components/ReadGroup.js", "oflo-oflo-ide/deps/noflo-groups/components/ReadGroup.js");
require.alias("noflo-noflo-groups/components/SendByGroup.js", "oflo-oflo-ide/deps/noflo-groups/components/SendByGroup.js");
require.alias("noflo-noflo-groups/components/CollectGroups.js", "oflo-oflo-ide/deps/noflo-groups/components/CollectGroups.js");
require.alias("noflo-noflo-groups/components/CollectObject.js", "oflo-oflo-ide/deps/noflo-groups/components/CollectObject.js");
require.alias("noflo-noflo-groups/components/FirstGroup.js", "oflo-oflo-ide/deps/noflo-groups/components/FirstGroup.js");
require.alias("noflo-noflo-groups/components/MapGroup.js", "oflo-oflo-ide/deps/noflo-groups/components/MapGroup.js");
require.alias("noflo-noflo-groups/components/MergeGroups.js", "oflo-oflo-ide/deps/noflo-groups/components/MergeGroups.js");
require.alias("noflo-noflo-groups/components/GroupByObjectKey.js", "oflo-oflo-ide/deps/noflo-groups/components/GroupByObjectKey.js");
...
require.alias("noflo-fbp/lib/fbp.js", "noflo-fbp/index.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "noflo-noflo/index.js");
require.alias("noflo-noflo-dom/index.js", "oflo-oflo-ide/deps/noflo-dom/index.js");
require.alias("noflo-noflo-dom/component.json", "oflo-oflo-ide/deps/noflo-dom/component.json");
require.alias("noflo-noflo-dom/components/AddClass.js", "oflo-oflo-ide/deps/noflo-dom/components/AddClass.js");
require.alias("noflo-noflo-dom/components/AppendChild.js", "oflo-oflo-ide/deps/noflo-dom/components/AppendChild.js");
require.alias("noflo-noflo-dom/components/CreateElement.js", "oflo-oflo-ide/deps/noflo-dom/components/CreateElement.js");
require.alias("noflo-noflo-dom/components/CreateFragment.js", "oflo-oflo-ide/deps/noflo-dom/components/CreateFragment.js");
require.alias("noflo-noflo-dom/components/GetAttribute.js", "oflo-oflo-ide/deps/noflo-dom/components/GetAttribute.js");
require.alias("noflo-noflo-dom/components/GetElement.js", "oflo-oflo-ide/deps/noflo-dom/components/GetElement.js");
require.alias("noflo-noflo-dom/components/HasClass.js", "oflo-oflo-ide/deps/noflo-dom/components/HasClass.js");
require.alias("noflo-noflo-dom/components/ReadHtml.js", "oflo-oflo-ide/deps/noflo-dom/components/ReadHtml.js");
require.alias("noflo-noflo-dom/components/RemoveElement.js", "oflo-oflo-ide/deps/noflo-dom/components/RemoveElement.js");
require.alias("noflo-noflo-dom/components/SetAttribute.js", "oflo-oflo-ide/deps/noflo-dom/components/SetAttribute.js");
require.alias("noflo-noflo-dom/components/WriteHtml.js", "oflo-oflo-ide/deps/noflo-dom/components/WriteHtml.js");
require.alias("noflo-noflo-dom/components/RemoveClass.js", "oflo-oflo-ide/deps/noflo-dom/components/RemoveClass.js");
require.alias("noflo-noflo-dom/components/RequestAnimationFrame.js", "oflo-oflo-ide/deps/noflo-dom/components/RequestAnimationFrame.js");
...
require.alias("noflo-fbp/lib/fbp.js", "noflo-fbp/index.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "noflo-noflo/index.js");
require.alias("noflo-noflo-core/index.js", "oflo-oflo-ide/deps/noflo-core/index.js");
require.alias("noflo-noflo-core/component.json", "oflo-oflo-ide/deps/noflo-core/component.json");
require.alias("noflo-noflo-core/components/Callback.js", "oflo-oflo-ide/deps/noflo-core/components/Callback.js");
require.alias("noflo-noflo-core/components/DisconnectAfterPacket.js", "oflo-oflo-ide/deps/noflo-core/components/DisconnectAfterPacket.js");
require.alias("noflo-noflo-core/components/Drop.js", "oflo-oflo-ide/deps/noflo-core/components/Drop.js");
require.alias("noflo-noflo-core/components/Group.js", "oflo-oflo-ide/deps/noflo-core/components/Group.js");
require.alias("noflo-noflo-core/components/Kick.js", "oflo-oflo-ide/deps/noflo-core/components/Kick.js");
require.alias("noflo-noflo-core/components/Merge.js", "oflo-oflo-ide/deps/noflo-core/components/Merge.js");
require.alias("noflo-noflo-core/components/Output.js", "oflo-oflo-ide/deps/noflo-core/components/Output.js");
require.alias("noflo-noflo-core/components/Repeat.js", "oflo-oflo-ide/deps/noflo-core/components/Repeat.js");
require.alias("noflo-noflo-core/components/RepeatAsync.js", "oflo-oflo-ide/deps/noflo-core/components/RepeatAsync.js");
require.alias("noflo-noflo-core/components/Split.js", "oflo-oflo-ide/deps/noflo-core/components/Split.js");
require.alias("noflo-noflo-core/components/RunInterval.js", "oflo-oflo-ide/deps/noflo-core/components/RunInterval.js");
require.alias("noflo-noflo-core/components/MakeFunction.js", "oflo-oflo-ide/deps/noflo-core/components/MakeFunction.js");
...
require.alias("oflo-oflo-ide/index.js", "oflo-oflo-ide/index.js");
require.alias("meemoo-dataflow/build/dataflow.build.js", "oflo-orion/deps/dataflow/build/dataflow.build.js");
require.alias("meemoo-dataflow/build/dataflow.build.js", "oflo-orion/deps/dataflow/index.js");
require.alias("meemoo-dataflow/build/dataflow.build.js", "dataflow/index.js");
require.alias("meemoo-dataflow/build/dataflow.build.js", "meemoo-dataflow/index.js");
require.alias("component-emitter/index.js", "oflo-orion/deps/emitter/index.js");
require.alias("component-emitter/index.js", "emitter/index.js");
require.alias("component-indexof/index.js", "component-emitter/deps/indexof/index.js");

require.alias("noflo-noflo/component.json", "oflo-orion/deps/noflo/component.json");
require.alias("noflo-noflo/src/lib/Graph.js", "oflo-orion/deps/noflo/src/lib/Graph.js");
require.alias("noflo-noflo/src/lib/InternalSocket.js", "oflo-orion/deps/noflo/src/lib/InternalSocket.js");
require.alias("noflo-noflo/src/lib/Port.js", "oflo-orion/deps/noflo/src/lib/Port.js");
require.alias("noflo-noflo/src/lib/ArrayPort.js", "oflo-orion/deps/noflo/src/lib/ArrayPort.js");
require.alias("noflo-noflo/src/lib/Component.js", "oflo-orion/deps/noflo/src/lib/Component.js");
require.alias("noflo-noflo/src/lib/AsyncComponent.js", "oflo-orion/deps/noflo/src/lib/AsyncComponent.js");
require.alias("noflo-noflo/src/lib/LoggingComponent.js", "oflo-orion/deps/noflo/src/lib/LoggingComponent.js");
require.alias("noflo-noflo/src/lib/ComponentLoader.js", "oflo-orion/deps/noflo/src/lib/ComponentLoader.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "oflo-orion/deps/noflo/src/lib/NoFlo.js");
require.alias("noflo-noflo/src/lib/Network.js", "oflo-orion/deps/noflo/src/lib/Network.js");
require.alias("noflo-noflo/src/components/Graph.js", "oflo-orion/deps/noflo/src/components/Graph.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "oflo-orion/deps/noflo/index.js");
...
require.alias("noflo-fbp/lib/fbp.js", "noflo-fbp/index.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "noflo-noflo/index.js");
require.alias("noflo-noflo-strings/index.js", "oflo-orion/deps/noflo-strings/index.js");
require.alias("noflo-noflo-strings/component.json", "oflo-orion/deps/noflo-strings/component.json");
require.alias("noflo-noflo-strings/components/CompileString.js", "oflo-orion/deps/noflo-strings/components/CompileString.js");
require.alias("noflo-noflo-strings/components/Filter.js", "oflo-orion/deps/noflo-strings/components/Filter.js");
require.alias("noflo-noflo-strings/components/SendString.js", "oflo-orion/deps/noflo-strings/components/SendString.js");
require.alias("noflo-noflo-strings/components/SplitStr.js", "oflo-orion/deps/noflo-strings/components/SplitStr.js");
require.alias("noflo-noflo-strings/components/StringTemplate.js", "oflo-orion/deps/noflo-strings/components/StringTemplate.js");
require.alias("noflo-noflo-strings/components/Replace.js", "oflo-orion/deps/noflo-strings/components/Replace.js");
require.alias("noflo-noflo-strings/components/Jsonify.js", "oflo-orion/deps/noflo-strings/components/Jsonify.js");
require.alias("noflo-noflo-strings/components/ParseJson.js", "oflo-orion/deps/noflo-strings/components/ParseJson.js");
...
require.alias("noflo-noflo-ajax/index.js", "oflo-orion/deps/noflo-ajax/index.js");
require.alias("noflo-noflo-ajax/component.json", "oflo-orion/deps/noflo-ajax/component.json");
require.alias("noflo-noflo-ajax/components/Get.js", "oflo-orion/deps/noflo-ajax/components/Get.js");
require.alias("noflo-noflo-ajax/components/GetJsonP.js", "oflo-orion/deps/noflo-ajax/components/GetJsonP.js");
...
require.alias("noflo-fbp/lib/fbp.js", "noflo-fbp/index.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "noflo-noflo/index.js");
require.alias("noflo-noflo-localstorage/index.js", "oflo-orion/deps/noflo-localstorage/index.js");
require.alias("noflo-noflo-localstorage/component.json", "oflo-orion/deps/noflo-localstorage/component.json");
require.alias("noflo-noflo-localstorage/components/GetItem.js", "oflo-orion/deps/noflo-localstorage/components/GetItem.js");
require.alias("noflo-noflo-localstorage/components/ListenRemoteChanges.js", "oflo-orion/deps/noflo-localstorage/components/ListenRemoteChanges.js");
require.alias("noflo-noflo-localstorage/components/ListAdd.js", "oflo-orion/deps/noflo-localstorage/components/ListAdd.js");
require.alias("noflo-noflo-localstorage/components/ListGet.js", "oflo-orion/deps/noflo-localstorage/components/ListGet.js");
require.alias("noflo-noflo-localstorage/components/ListRemove.js", "oflo-orion/deps/noflo-localstorage/components/ListRemove.js");
require.alias("noflo-noflo-localstorage/components/RemoveItem.js", "oflo-orion/deps/noflo-localstorage/components/RemoveItem.js");
require.alias("noflo-noflo-localstorage/components/SetItem.js", "oflo-orion/deps/noflo-localstorage/components/SetItem.js");
...
require.alias("noflo-fbp/lib/fbp.js", "noflo-fbp/index.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "noflo-noflo/index.js");
require.alias("noflo-noflo-interaction/index.js", "oflo-orion/deps/noflo-interaction/index.js");
require.alias("noflo-noflo-interaction/component.json", "oflo-orion/deps/noflo-interaction/component.json");
require.alias("noflo-noflo-interaction/components/ListenDrag.js", "oflo-orion/deps/noflo-interaction/components/ListenDrag.js");
require.alias("noflo-noflo-interaction/components/ListenHash.js", "oflo-orion/deps/noflo-interaction/components/ListenHash.js");
require.alias("noflo-noflo-interaction/components/ListenKeyboard.js", "oflo-orion/deps/noflo-interaction/components/ListenKeyboard.js");
require.alias("noflo-noflo-interaction/components/ListenMouse.js", "oflo-orion/deps/noflo-interaction/components/ListenMouse.js");
require.alias("noflo-noflo-interaction/components/ListenPointer.js", "oflo-orion/deps/noflo-interaction/components/ListenPointer.js");
require.alias("noflo-noflo-interaction/components/ListenScroll.js", "oflo-orion/deps/noflo-interaction/components/ListenScroll.js");
require.alias("noflo-noflo-interaction/components/ListenSpeech.js", "oflo-orion/deps/noflo-interaction/components/ListenSpeech.js");
require.alias("noflo-noflo-interaction/components/ListenTouch.js", "oflo-orion/deps/noflo-interaction/components/ListenTouch.js");
require.alias("noflo-noflo-interaction/components/SetHash.js", "oflo-orion/deps/noflo-interaction/components/SetHash.js");
require.alias("noflo-noflo-interaction/components/ReadCoordinates.js", "oflo-orion/deps/noflo-interaction/components/ReadCoordinates.js");
...
require.alias("noflo-fbp/lib/fbp.js", "noflo-fbp/index.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "noflo-noflo/index.js");
require.alias("noflo-noflo-objects/index.js", "oflo-orion/deps/noflo-objects/index.js");
require.alias("noflo-noflo-objects/component.json", "oflo-orion/deps/noflo-objects/component.json");
require.alias("noflo-noflo-objects/components/Extend.js", "oflo-orion/deps/noflo-objects/components/Extend.js");
require.alias("noflo-noflo-objects/components/MergeObjects.js", "oflo-orion/deps/noflo-objects/components/MergeObjects.js");
require.alias("noflo-noflo-objects/components/SplitObject.js", "oflo-orion/deps/noflo-objects/components/SplitObject.js");
require.alias("noflo-noflo-objects/components/ReplaceKey.js", "oflo-orion/deps/noflo-objects/components/ReplaceKey.js");
require.alias("noflo-noflo-objects/components/Keys.js", "oflo-orion/deps/noflo-objects/components/Keys.js");
require.alias("noflo-noflo-objects/components/Size.js", "oflo-orion/deps/noflo-objects/components/Size.js");
require.alias("noflo-noflo-objects/components/Values.js", "oflo-orion/deps/noflo-objects/components/Values.js");
require.alias("noflo-noflo-objects/components/Join.js", "oflo-orion/deps/noflo-objects/components/Join.js");
require.alias("noflo-noflo-objects/components/ExtractProperty.js", "oflo-orion/deps/noflo-objects/components/ExtractProperty.js");
require.alias("noflo-noflo-objects/components/InsertProperty.js", "oflo-orion/deps/noflo-objects/components/InsertProperty.js");
require.alias("noflo-noflo-objects/components/SliceArray.js", "oflo-orion/deps/noflo-objects/components/SliceArray.js");
require.alias("noflo-noflo-objects/components/SplitArray.js", "oflo-orion/deps/noflo-objects/components/SplitArray.js");
require.alias("noflo-noflo-objects/components/FilterPropertyValue.js", "oflo-orion/deps/noflo-objects/components/FilterPropertyValue.js");
require.alias("noflo-noflo-objects/components/FlattenObject.js", "oflo-orion/deps/noflo-objects/components/FlattenObject.js");
require.alias("noflo-noflo-objects/components/MapProperty.js", "oflo-orion/deps/noflo-objects/components/MapProperty.js");
require.alias("noflo-noflo-objects/components/RemoveProperty.js", "oflo-orion/deps/noflo-objects/components/RemoveProperty.js");
require.alias("noflo-noflo-objects/components/MapPropertyValue.js", "oflo-orion/deps/noflo-objects/components/MapPropertyValue.js");
require.alias("noflo-noflo-objects/components/GetObjectKey.js", "oflo-orion/deps/noflo-objects/components/GetObjectKey.js");
require.alias("noflo-noflo-objects/components/UniqueArray.js", "oflo-orion/deps/noflo-objects/components/UniqueArray.js");
require.alias("noflo-noflo-objects/components/SetProperty.js", "oflo-orion/deps/noflo-objects/components/SetProperty.js");
require.alias("noflo-noflo-objects/components/SimplifyObject.js", "oflo-orion/deps/noflo-objects/components/SimplifyObject.js");
require.alias("noflo-noflo-objects/components/DuplicateProperty.js", "oflo-orion/deps/noflo-objects/components/DuplicateProperty.js");
require.alias("noflo-noflo-objects/components/CreateObject.js", "oflo-orion/deps/noflo-objects/components/CreateObject.js");
require.alias("noflo-noflo-objects/components/CreateDate.js", "oflo-orion/deps/noflo-objects/components/CreateDate.js");
require.alias("noflo-noflo-objects/components/SetPropertyValue.js", "oflo-orion/deps/noflo-objects/components/SetPropertyValue.js");
require.alias("noflo-noflo-objects/components/CallMethod.js", "oflo-orion/deps/noflo-objects/components/CallMethod.js");
...
require.alias("noflo-noflo-groups/index.js", "oflo-orion/deps/noflo-groups/index.js");
require.alias("noflo-noflo-groups/component.json", "oflo-orion/deps/noflo-groups/component.json");
require.alias("noflo-noflo-groups/components/ReadGroups.js", "oflo-orion/deps/noflo-groups/components/ReadGroups.js");
require.alias("noflo-noflo-groups/components/RemoveGroups.js", "oflo-orion/deps/noflo-groups/components/RemoveGroups.js");
require.alias("noflo-noflo-groups/components/Regroup.js", "oflo-orion/deps/noflo-groups/components/Regroup.js");
require.alias("noflo-noflo-groups/components/Group.js", "oflo-orion/deps/noflo-groups/components/Group.js");
require.alias("noflo-noflo-groups/components/GroupZip.js", "oflo-orion/deps/noflo-groups/components/GroupZip.js");
require.alias("noflo-noflo-groups/components/FilterByGroup.js", "oflo-orion/deps/noflo-groups/components/FilterByGroup.js");
require.alias("noflo-noflo-groups/components/Objectify.js", "oflo-orion/deps/noflo-groups/components/Objectify.js");
require.alias("noflo-noflo-groups/components/ReadGroup.js", "oflo-orion/deps/noflo-groups/components/ReadGroup.js");
require.alias("noflo-noflo-groups/components/SendByGroup.js", "oflo-orion/deps/noflo-groups/components/SendByGroup.js");
require.alias("noflo-noflo-groups/components/CollectGroups.js", "oflo-orion/deps/noflo-groups/components/CollectGroups.js");
require.alias("noflo-noflo-groups/components/CollectObject.js", "oflo-orion/deps/noflo-groups/components/CollectObject.js");
require.alias("noflo-noflo-groups/components/FirstGroup.js", "oflo-orion/deps/noflo-groups/components/FirstGroup.js");
require.alias("noflo-noflo-groups/components/MapGroup.js", "oflo-orion/deps/noflo-groups/components/MapGroup.js");
require.alias("noflo-noflo-groups/components/MergeGroups.js", "oflo-orion/deps/noflo-groups/components/MergeGroups.js");
require.alias("noflo-noflo-groups/components/GroupByObjectKey.js", "oflo-orion/deps/noflo-groups/components/GroupByObjectKey.js");
...
require.alias("noflo-fbp/lib/fbp.js", "noflo-fbp/index.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "noflo-noflo/index.js");
require.alias("noflo-noflo-dom/index.js", "oflo-orion/deps/noflo-dom/index.js");
require.alias("noflo-noflo-dom/component.json", "oflo-orion/deps/noflo-dom/component.json");
require.alias("noflo-noflo-dom/components/AddClass.js", "oflo-orion/deps/noflo-dom/components/AddClass.js");
require.alias("noflo-noflo-dom/components/AppendChild.js", "oflo-orion/deps/noflo-dom/components/AppendChild.js");
require.alias("noflo-noflo-dom/components/CreateElement.js", "oflo-orion/deps/noflo-dom/components/CreateElement.js");
require.alias("noflo-noflo-dom/components/CreateFragment.js", "oflo-orion/deps/noflo-dom/components/CreateFragment.js");
require.alias("noflo-noflo-dom/components/GetAttribute.js", "oflo-orion/deps/noflo-dom/components/GetAttribute.js");
require.alias("noflo-noflo-dom/components/GetElement.js", "oflo-orion/deps/noflo-dom/components/GetElement.js");
require.alias("noflo-noflo-dom/components/HasClass.js", "oflo-orion/deps/noflo-dom/components/HasClass.js");
require.alias("noflo-noflo-dom/components/ReadHtml.js", "oflo-orion/deps/noflo-dom/components/ReadHtml.js");
require.alias("noflo-noflo-dom/components/RemoveElement.js", "oflo-orion/deps/noflo-dom/components/RemoveElement.js");
require.alias("noflo-noflo-dom/components/SetAttribute.js", "oflo-orion/deps/noflo-dom/components/SetAttribute.js");
require.alias("noflo-noflo-dom/components/WriteHtml.js", "oflo-orion/deps/noflo-dom/components/WriteHtml.js");
require.alias("noflo-noflo-dom/components/RemoveClass.js", "oflo-orion/deps/noflo-dom/components/RemoveClass.js");
require.alias("noflo-noflo-dom/components/RequestAnimationFrame.js", "oflo-orion/deps/noflo-dom/components/RequestAnimationFrame.js");
...
require.alias("noflo-fbp/lib/fbp.js", "noflo-fbp/index.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "noflo-noflo/index.js");
require.alias("noflo-noflo-core/index.js", "oflo-orion/deps/noflo-core/index.js");
require.alias("noflo-noflo-core/component.json", "oflo-orion/deps/noflo-core/component.json");
require.alias("noflo-noflo-core/components/Callback.js", "oflo-orion/deps/noflo-core/components/Callback.js");
require.alias("noflo-noflo-core/components/DisconnectAfterPacket.js", "oflo-orion/deps/noflo-core/components/DisconnectAfterPacket.js");
require.alias("noflo-noflo-core/components/Drop.js", "oflo-orion/deps/noflo-core/components/Drop.js");
require.alias("noflo-noflo-core/components/Group.js", "oflo-orion/deps/noflo-core/components/Group.js");
require.alias("noflo-noflo-core/components/Kick.js", "oflo-orion/deps/noflo-core/components/Kick.js");
require.alias("noflo-noflo-core/components/Merge.js", "oflo-orion/deps/noflo-core/components/Merge.js");
require.alias("noflo-noflo-core/components/Output.js", "oflo-orion/deps/noflo-core/components/Output.js");
require.alias("noflo-noflo-core/components/Repeat.js", "oflo-orion/deps/noflo-core/components/Repeat.js");
require.alias("noflo-noflo-core/components/RepeatAsync.js", "oflo-orion/deps/noflo-core/components/RepeatAsync.js");
require.alias("noflo-noflo-core/components/Split.js", "oflo-orion/deps/noflo-core/components/Split.js");
require.alias("noflo-noflo-core/components/RunInterval.js", "oflo-orion/deps/noflo-core/components/RunInterval.js");
require.alias("noflo-noflo-core/components/MakeFunction.js", "oflo-orion/deps/noflo-core/components/MakeFunction.js");
...
require.alias("oflo-orion/index.js", "oflo-orion/index.js");